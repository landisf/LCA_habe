...
My analysis focuses on policies that imply direct costs for consumers in proportion to their emissions.
...
While the \ac{eu} has decided to regulate additional parts of its economy with a carbon price when it created the so called EU ETS2 for heating and tranport fuels, it is far from certain that Switzerland will follow suit.
...
The observation is that Switzerland has already chosen to implement carbon pricing for one of the distributionally least attractive consumption goods and things would only get better with adding others.
...
Thus, my analysis does not take into account potential changes in consumption patterns or efficiency improvements since the survey was conducted let alone give a outlook of how consumption patterns may look in the future.
