...
As a consequence, emissions-intensity of consumption (measured as \ac{gwp} per spending in kg \ac{co2e} per CHF) is higher for low-income decile groups than for high-income ones (top panel in Figure~\ref{fig:gwp_chf}).
...
While the orange, dashed line (\emph{Total}) corresponds to the line in \ref{fig:carbonP},
...
\bmhead{Acknowledgements}
  ...
  Two anonymous referees and the corresponding editor, Jérémy Laurent-Lucchetti, made helpful suggestions to further improve both the analysis in this paper and the political framing of its findings.
...
This rather clear trend, observed when controlling for income, is attenuated somewhat in Figure~\ref{fig:types}, however, indicating that bigger households tend to be of higher lifetime income which additionally increases their \ac{gwp} when not comparing for income.
