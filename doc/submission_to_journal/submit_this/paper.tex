...
This rendering shows that, in terms of averages (depicted by circles in the figure), the net benefits relative to household spending are larger for low-income households than the smplified net costs (direct costs minus refunds) for high-income households.
